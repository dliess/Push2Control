#ifndef VOICE_SELECTION_MODEL_H
#define VOICE_SELECTION_MODEL_H
...
class VoiceSelectionModel : public QAbstractListModel
{
    Q_OBJECT
...
public:
    ...
    VoiceSelectionModel(MusicDeviceHolder&   rMidiOpenedPorts,
