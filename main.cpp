...
//    std::signal(SIGINT, signalHandler); // overwrite loggers signal handler
    ...
    midi::MidiMediumDummy dummy9("MIDIFACE 8x8:MIDIFACE 8x8 MIDI 1", midi::IMidiMedium::Type::USB);
    midi::MidiMediumDummy dummy10("MIDIFACE 8x8:MIDIFACE 8x8 MIDI 2", midi::IMidiMedium::Type::USB);   
    midi::MidiMediumDummy dummy11("MIDIFACE 8x8:MIDIFACE 8x8 MIDI 3", midi::IMidiMedium::Type::USB);   
    midi::MidiMediumDummy dummy12("MIDIFACE 8x8:MIDIFACE 8x8 MIDI 4", midi::IMidiMedium::Type::USB);   
